            ...
            <div className="max-w-[1600px] mx-auto space-y-10">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                    ...
                    >
                        ...
                        <p className="text-gray-500 font-medium text-lg">Manage your project pipeline with precision.</p>
                    </motion.div>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-12 gap-10">
                    ...
                    <div className="xl:col-span-7 space-y-4">
                        ...
                        <div className="space-y-4 custom-scrollbar max-h-[calc(100vh-350px)] overflow-y-auto pr-2">
                            {filteredInquiries.length > 0 ? filteredInquiries.map((inquiry, i) => (
                                <motion.div
                                    ...
                                    className={`group relative overflow-hidden cursor-pointer bg-[#0a0a0f] border rounded-[2.5rem] p-8 transition-all duration-500
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-4 mb-3">
                                                <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-xl border border-white/10 group-hover:bg-brand-purple/10 group-hover:border-brand-purple/20 transition-colors">
                                                    {inquiry.name.charAt(0)}
                                                </div>
                                                <div>
                                                    <h3 className="text-xl font-black text-white leading-tight group-hover:text-brand-purple transition-colors">{inquiry.name}</h3>
                                                    <p className="text-gray-500 text-xs font-bold">{inquiry.company ?? 'Individual Client'}</p>
                                                </div>
                                            </div>
                                            <div className="flex gap-2">
                                        ...
                                        <div className="flex flex-row sm:flex-col items-center sm:items-end justify-between sm:justify-center gap-4">
                                            <div className={`px-5 py-2 rounded-2xl text-[9px] font-black uppercase tracking-[0.2em] border shadow-sm
                                ...
                                <div className="bg-[#0a0a0f] border border-dashed border-white/10 rounded-[3rem] py-32 text-center">
                                    <p className="text-gray-500 font-black uppercase tracking-[0.3em] text-sm">No leads match your filter.</p>
                                </div>
                            )}
                        </div>
                    </div>
                        ...
                        <AnimatePresence mode="wait">
                            {selectedInquiry ? (
                                <motion.div
                                    ...
                                    className="bg-[#0a0a0f] border border-white/10 rounded-[3rem] p-10 sticky top-10 shadow-2xl overflow-hidden"
                                >
                                    ...
                                    <div className="relative z-10">
                                        <div className="flex justify-between items-start mb-12">
                                            <div>
                                                ...
                                                <h2 className="text-4xl font-black tracking-tighter text-white mb-2">{selectedInquiry.name}</h2>
                                                <div className="flex items-center gap-3">
                                                    <span className="text-gray-500 font-bold text-sm">{selectedInquiry.email}</span>
                                                    <button 
                                        ...
                                        <div className="grid grid-cols-2 gap-6 mb-10">
                                            <div className="p-6 bg-white/5 rounded-[2rem] border border-white/10 group hover:border-white/20 transition-all">
                                        ...
                                        <div className="p-8 bg-gradient-to-br from-brand-purple/20 to-blue-600/10 rounded-[2.5rem] border border-white/10 mb-10">
                                            ...
                                            <div className="flex items-center gap-6">
                                                <div className="flex flex-col">
                                                    <p className="text-3xl font-black text-white">{new Date(selectedInquiry.meeting_date + 'T00:00:00').toLocaleDateString('en-US', { day: 'numeric', month: 'short' })}</p>
                                                    <p className="text-xs font-bold text-brand-purple uppercase tracking-widest">{selectedInquiry.meeting_time}</p>
                                                </div>
                                                <div className="h-10 w-[1px] bg-white/10" />
                                                <p className="text-[10px] text-gray-400 font-medium leading-relaxed italic">
                                                    This slot has been pre-selected by the client.
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mb-10">
                                            ...
                                            <div className="p-8 bg-white/5 rounded-[2.5rem] border border-white/10 text-sm text-gray-300 leading-relaxed font-medium min-h-[150px]">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="inline-flex gap-2 p-1.5 bg-white/5 rounded-2xl border border-white/10">
