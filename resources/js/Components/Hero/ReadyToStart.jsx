...
export default function ReadyToStart() {
    ...
    return (
        <section id="ready-to-start" className="py-24 bg-white relative overflow-hidden">
            {/* Background Decor */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-brand-purple/[0.03] blur-[120px] rounded-full pointer-events-none" />

            <div className="container mx-auto px-6 relative z-10">
                <div className="max-w-5xl mx-auto bg-gray-50 border border-gray-100 rounded-[3rem] overflow-hidden shadow-2xl shadow-gray-200/50">
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                        {/* Info Side */}
                        <div className="p-12 lg:p-16 bg-gradient-to-br from-brand-purple/[0.08] to-transparent flex flex-col justify-center">
                            <motion.span
                            ...
                            <div className="space-y-6">
                                {[
                                    ...
                                    <div key={i} className="flex items-center gap-4">
                                        ...
                                        <span className="text-gray-900 font-bold text-sm tracking-wide">{item.text}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="p-12 lg:p-16 border-l border-white/10">
                            {submitted ? (
                                ...
                                >
                                    ...
                                    <p className="text-gray-600 font-normal">We've received your inquiry and will get back to you within 24 hours.</p>
                                </motion.div>
                            ) : (
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-white border border-gray-200 rounded-2xl px-6 py-4 text-gray-900 focus:outline-none focus:border-brand-purple transition-all placeholder:text-gray-300"
                                                required
                                            />
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-2">Tell us more</label>
                                        <textarea
                                            value={data.message}
                                            onChange={e => setData('message', e.target.value)}
                                            placeholder="I have an idea for..."
                                            rows="4"
                                            className="w-full bg-white border border-gray-200 rounded-2xl px-6 py-4 text-gray-900 focus:outline-none focus:border-brand-purple transition-all resize-none placeholder:text-gray-300"
                                        ></textarea>
                                    </div>
